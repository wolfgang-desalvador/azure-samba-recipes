...
apt-get update
apt-get -y install krb5-user samba sssd sssd-tools libnss-sss libpam-sss ntp ntpdate realmd adcli winbind
...
mv /etc/samba/smb.conf /etc/samba/smb.conf.bak.sssd_join || true
